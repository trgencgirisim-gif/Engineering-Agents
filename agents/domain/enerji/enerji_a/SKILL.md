...
### `pypsa`
Energy system optimization: dispatch, capacity expansion, power flow
**Input parameters:**
    - `analysis_type`: string (required) — Type of energy system analysis to perform
    - `network_params`: object — Network configuration parameters
