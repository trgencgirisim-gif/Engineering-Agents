...
### `pybullet`
Robotics dynamics: forward/inverse kinematics, multi-body simulation
**Input parameters:**
    - `simulation_type`: string (required) — Type of robotics simulation
    - `robot_params`: object (required) — Robot parameters
